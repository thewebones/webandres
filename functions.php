<?php
/**
 * Web Andres functions and definitions
 *
...
if ( ! function_exists( 'web_andres_setup' ) ) :
	...
	function web_andres_setup() {
		 ...
		 * If you're building a theme based on Web Andres, use a find and replace
		 * to change 'web-andres' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'web-andres', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'web-andres' ),
			)
		);
...
function web_andres_widgets_init() {
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'web-andres' ),
...
function web_andres_scripts() {
	...
	wp_enqueue_script( 'web-andres-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
